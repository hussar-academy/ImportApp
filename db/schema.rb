...
ActiveRecord::Schema.define(version: 20160331142614) do
  ...
  add_index "categories_operations", ["category_id", "operation_id"], name: "index_categories_operations_on_category_id_and_operation_id", using: :btree
